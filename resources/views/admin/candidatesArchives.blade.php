                    ...
                    <div class="md:col-span-2 lg:col-span-1" >
                        <div class="h-full py-8 px-6 space-y-6 rounded-xl border rounded-tl-none overflow-auto border-gray-200 bg-white min-h-[calc(100vh-120px)]">
                            <div class = "flex w-full justify-between min-w-[900px]">
                                ...
                                <form class = "flex relative rounded-lg gap-1" method="GET" action="{{ URL('/admin/candidates/archives') }}">
                                    @csrf
                            ...
                            <table class="min-w-[900px] text-sm md:text-base overflow-auto w-full ">
                                    ...
                                    <th class = "px-2 w-40 hidden" id = "multiSelect">
                                        ...
                                        <g>
                                            ...
                                            shadow-md flex flex-col border bg-white z-[9]">
                                                <form method = "POST" action = "{{URL('admin/candidates/multiRetrieve')}}">
                                                    @csrf
                                                ...
                                                <form method = "POST" action = "{{URL('admin/candidates/multiDelete')}}">
                                                    @csrf
                                                    <div class = "multiSelectInputs">
                                ...
                                @else
                                    @foreach($applications as $application)
                                        <tr class = "text-center max-h-[80vh]">
                                            <td><input type="checkbox" name = "selected" onclick="selectOne()" value = "{{$application->id}}"></td>
                                            ...
                                            <td class = "px-2">{{$application->created_at}}</td>
                                            <td class="flex gap-1 justify-center">
                                                <form method = "POST" action="{{URL('admin/fileCandidacy/archive/retrieve',['application' => $application->id])}}">
                                                    @csrf
                                                    <button class="bg-greenBPC hover:bg-darkGreenBPC text-white p-2 rounded-md">Retrieve</button>
                                                </form> 
                                                <form method = "POST" action="{{URL('admin/fileCandidacy/archive/destroy',['application' => $application->id])}}">
                                                    @csrf
                                                    @method('DELETE')
