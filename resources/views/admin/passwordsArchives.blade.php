                    ...
                    <div class="md:col-span-2 lg:col-span-1" >
                        <div class="h-full py-8 px-6 space-y-6 rounded-xl border rounded-tl-none overflow-auto border-gray-200 bg-white min-h-[calc(100vh-120px)]">
                            <div class = "flex w-full justify-between min-w-[900px]">
                                ...
                                <form class = "flex relative rounded-lg gap-1" action="{{URL('admin/passwords/archives')}}" method="GET">
                                    @csrf
                            ...
                            <table class="min-w-[900px] text-sm md:text-base overflow-auto w-full ">
                                <thead class = "" id = "thead">
                                    <th class = "px-2"><input type="checkbox" id = "selectAll" onclick="selectAll(this)"></th>
                                    <th>Student ID</th>
                                    <th>Full Name</th>
                                    <th>Reason</th>
                                    <th>Proof of Identity</th>
                                    <th>Status</th>
                                    <th class = "w-40" id = "operations">Operations</th>
                                    <th class = "px-2 w-40 hidden" id = "multiSelect">
                                        ...
                                        <g>
                                            ...
                                            shadow-md flex flex-col border bg-white z-[9]">
                                                <form method = "POST" action = "{{URL('admin/passwords/multiRetrieve')}}">
                                                    @csrf
                                                    <div class = "multiSelectInputs">
                                                        
                                                    </div>
                                                    <button type = "submit" class = "py-2 font-normal">Retrieve</button>
                                                </form>
                                                <form method = "POST" action = "{{URL('admin/passwords/multiDelete')}}">
                                                    @csrf
                                                    <div class = "multiSelectInputs">
                                                        
                                                    </div>
                                                    <button type = "submit" class = "py-2 font-normal">Delete</button>
                                                </form>
                                            </div>
                                        </details>
                                    </th>
                                ...
                                @else
                                    ...
                                    <tr class = "text-center max-h-[80vh]">
                                        <td><input type="checkbox" name = "selected" onclick="selectOne()" value = "{{$request->id}}"></td>
                                        ...
                                        <td class="flex gap-1 justify-center">
                                            ...
                                            <form method = "POST" action = "{{URL('/admin/passwords/archives/retrieve', ['id' => $request->id])}}" class="flex gap-1 justify-center">
                                                @csrf
                                                <button class="bg-greenBPC hover:bg-darkGreenBPC text-white p-2 rounded-md">Retrieve</button>
                                            </form>
                                            <form method = "POST" action = "{{URL('/admin/passwords/archives/delete', ['id' => $request->id])}}" class="flex gap-1 justify-center">
                                                @csrf
                                                @method('DELETE')
                                                <button class="bg-red-600 hover:bg-red-800 text-white p-2 rounded-md">Delete</button>
                                            </form>
